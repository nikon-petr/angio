...
<table border="0" cellpadding="4pt" width="100%">
    <tr>
        <td style="vertical-align:top" width="50%">
            <p style="text-align: left">
                ...
                <#if data.additionalInfo.fullDescription?has_content>
                    <b>Описание:</b> ${data.additionalInfo.fullDescription}<br/>
                </#if>
                <#if data.additionalInfo.comment?has_content>
...
<#if data.bloodFlowAnalyse.ischemiaImage??>
    <h2>Степень кровоснабжения сосудистой системы</h2>
    <table border="0" cellpadding="4pt" width="100%" align="center">
                ...
                <table border="1" style="border-collapse: collapse" width="100%">
                    ...
                    <#list data.bloodFlowAnalyse.densities as density>
                        <tr>
                            ...
                            <td>${(density.density * 100)?string["0.##"]}</td>
                        </tr>
                    </#list>
                </table>
            </td>
...
<#if data.bloodFlowAnalyse.densityImage?? && !data.bloodFlowAnalyse.ischemiaImage??>
    ...
    <tr>
        ...
        <td style="text-align:left; vertical-align: top; padding: 5px">
            <p>
                <b>Плотность сосудов: </b> ${(data.bloodFlowAnalyse.densities[0].density * 100)?string["0.##"]}%<br/>
            </p>
        </td>
    </tr>
    </#if>
    <h2>Заключение</h2>
<#if data.additionalInfo.conclusion?has_content>
