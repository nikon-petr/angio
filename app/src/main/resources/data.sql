...
-- **************** patient ****************
INSERT INTO public.patient (firstname, lastname, patronymic, email, phone, bday, location_address, work_address, policy, comment)
    VALUES('Заболевальный', 'Иван', 'Семёнович', 'ivan_sem@gmail.com', '89271237898', '1985-05-06 00:00:00.000000', 'Саратов, ул. Посадского 228/226, 10', 'Саратов, ул. Московская 56', '9087675467878954', '');
INSERT INTO public.patient (firstname, lastname, patronymic, email, phone, bday, location_address, work_address, policy, comment)
    VALUES('Семакин', 'Пётр', 'Владимирович', 'semakin_sem@mail.ru', '89279385898', '1960-12-12 00:00:00.000000', 'Саратов, ул. Рахова 21, 90', 'На пенсии', '8207675467872250', '');
INSERT INTO public.patient (firstname, lastname, patronymic, email, phone, bday, location_address, work_address, policy, comment)
    VALUES('Козловский', 'Николай', 'Николаевич', 'kozlito@yandex.ru', '89699389098', '1992-02-16 00:00:00.000000', 'Саратов, ул. Чернышевского 240, 1', 'Саратов, ул. Степана Разина 8', '1276215467890790', '');

-- **************** analyse_info ****************
INSERT INTO public.analyse_info (username, patient_id, name, short_description, full_description, analyse_type, comment, img, analyse_date, finished, conclusion)
...
INSERT INTO public.analyse_info (username, patient_id, name, short_description, full_description, analyse_type, comment, img, analyse_date, finished, conclusion)
    VALUES ('user@angio.ru', 3, 'Первичный анализ глазного дна', 'Выявление проблемных зон, большое кол-во зон ишемии', '', 'Первичный анализ', '', '02.05.2018 07:40:27.630.png', '2018-04-06 11:21:00.000000', true, '');
INSERT INTO public.analyse_info (username, patient_id, name, short_description, full_description, analyse_type, comment, img, analyse_date, finished, conclusion)
